(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4862],
  {
    ...
    67029: (e, t, n) => {
      ...
      function v(e, t) {
        ...
        return o.createElement(
          ...
          w,
          C,
          o.createElement('span', { className: p(e, M, E) })
        );
      }
    ...
    31261: (e, t, n) => {
      ...
      function b(e) {
        ...
        const {
          ...
          E = (0, s.createSafeMulticastEventHandler)(y.onBlur, h),
          k = (0, o.useCallback)(
            (e) => {
              (m.current = e),
                g &&
        ...
        return o.createElement(v, {
          ...
          onBlur: E,
          reference: k,
          containerReference: (0, a.useMergedRefs)([f, p]),
          onMouseDown: C,
          onMouseUp: T,
        });
      }
    ...
    23263: (e, t, n) => {
        ...
        return o.createElement(
          ...
          s &&
            o.createElement(i.Icon, {
              className: m()(y().icon, y().startIcon),
              icon: s,
            }),
          !(0, v.isIconOnly)(n, r) &&
      ...
      E.displayName = 'RoundTabsButtons';
          ...
          if (t && l) {
            ...
            if (o) {
              const n = Array.from(o)
                ...
                .filter(h.notNull);
              n.length > 0 && t.removeSources(n, !1, L.format({ symbol: e }));
          ...
          o.createElement(
            ...
            b.length > 0 &&
              o.createElement(
                'div',
                { className: M.title },
                `${((S = u ? u[_].size : 0), s.t(null, { plural: '{symbolsCount} symbols', context: 'symbols_and_drawings_count', count: S }, n(52908)).format({ symbolsCount: S.toString() }))} ${((
                  e
                ) =>
                  s
                    .t(
            ...
            0 === b.length
              ? null === u
                ? o.createElement(g.Spinner, { className: M.spinner })
                : o.createElement(
                    'div',
                    { className: M.empty },
                    o.createElement(i.Icon, { className: M.image, icon: k }),
    ...
    67165: (e, t, n) => {
      ...
      function P(e) {
        const { hideTitle: t } = e,
          { viewModel: r } = (0, T.ensureNotNull)((0, o.useContext)(x)),
        ...
        return o.createElement(
          ...
          !t &&
            o.createElement(
              'div',
              { className: I(A.title, A.withoutIcon) },
          ...
          o.createElement(
            'div',
            { className: A.buttons },
            o.createElement(L.ToolWidgetIconButton, {
              className: I(A.button, !d && A.disabled),
              icon: R,
              onClick: function () {
            ...
            o.createElement(
              D.ToolWidgetMenu,
              {
                className: I(A.button, u && A.disabled),
                isDisabled: u,
                content: o.createElement(k.Icon, { icon: z }),
            ...
            o.createElement(
              D.ToolWidgetMenu,
              {
                className: I(A.button, l && A.disabled),
                isDisabled: l,
                content: o.createElement(k.Icon, { icon: j }),
            ...
            t &&
              o.createElement(
                o.Fragment,
                null,
                o.createElement('div', { className: A.spacing }),
                o.createElement(L.ToolWidgetIconButton, {
                  className: A.button,
                  icon: manageDrawingsIcon,
                  title: v.t(null, void 0, n(72357)),
      ...
      var B = n(54773),
        ...
        H = n(7809),
        V = n(23642);
      const G = ((U = 'OBJECT_TREE'), (e) => U + '__' + e);
      var U;
      const Z = G('SET_NODES'),
        K = G('SYNC_NODES'),
        Y = G('UPDATE_NODE'),
        $ = G('UPDATE_NODES'),
        q = G('RESET_TREE'),
        J = G('SET_SELECTED_IDS'),
        Q = G('DROP_SELECTION'),
        X = G('SELECT_PREVIOUS'),
        ee = G('SELECT_NEXT'),
        te = G('MULTI_SELECT_PREVIOUS'),
        ne = G('MULTI_SELECT_NEXT'),
        oe = G('PROCESS_DROP_TARGET'),
        re = G('UPDATE_DROP_TARGET'),
        ie = G('HIDE_DROP_TARGET'),
        se = G('START_MULTI_SELECT'),
        le = G('STOP_MULTI_SELECT'),
        ae = (G('REMOVE_NODE'), G('SET_FOCUSED_NODE')),
        ce = G('SCROLL_TO_ID'),
        ue = G('SET_IS_SELECTED'),
        de = G('SET_IS_EXPANDED'),
        he = G('SET_DISABLED_NODES'),
        ge = G('MOVE_NODES'),
        pe = (G('START_DRAG'), G('END_DRAG')),
        me = () => ({ type: X }),
        fe = () => ({ type: ee }),
        ve = () => ({ type: te }),
        be = () => ({ type: ne }),
        ...
        _e = () => ({ type: Q }),
        Se = (e) => ({ type: J, ids: e }),
        we = (e, t, n) => ({ type: ge, ids: e, targetId: t, dropType: n }),
        Ce = () => ({ type: se }),
        Te = () => ({ type: le }),
        Ie = (e) => ({ type: ae, nodeId: e }),
        Ee = (e) => ({ type: ce, nodeId: e }),
        ke = (e, t, n = 0) => ({ type: ue, nodeId: e, isSelected: t, mode: n }),
        Me = (e, t) => ({ type: de, nodeId: e, isExpanded: t }),
        De = (e) => ({ type: he, ids: e }),
        Ne = () => ({ type: pe });
      var xe = n(77145);
      const Le = (e) => e.nodes,
        ...
        Ae = (e) => e.scrollToId,
        Oe = (e, t) => t,
        Pe = (0, xe.createSelector)([Le, Oe], (e, t) => e[t]),
        Be = (0, xe.createSelector)([ze, Oe], (e, t) => e.ids.includes(t)),
        Fe = (0, xe.createSelector)([Re, Oe], (e, t) => e.includes(t)),
        We = (0, xe.createSelector)(
          [(e) => e.disabled, ze, Oe],
          (e, t, n) => !t.ids.includes(n) && e.includes(n)
        ),
        He = (0, xe.createSelector)(Le, (e) => Object.keys(e)),
        Ve = (0, xe.createSelector)(ze, ({ ids: e }) => e),
        Ge = (0, xe.createSelector)(ze, ({ lastFocusedNodeId: e }) => e),
        Ue = (0, xe.createSelector)(ze, ({ isMultiSelecting: e }) => e),
        Ze = (0, xe.createSelector)([Le, Ve], (e, t) => t.map((t) => e[t])),
        Ke = (0, xe.createSelector)(Le, (e) =>
          Object.values(e).filter((e) => 0 === e.level)
        ),
        Ye = (0, xe.createSelector)([Le, Ke], (e, t) =>
          t.reduce((t, n) => [...t, ...$e(e, (0, T.ensureDefined)(n))], [])
        );
      function $e(e, t) {
        const n = [];
      ...
      const qe = (0, xe.createSelector)([Le, Ke, Re], (e, t, n) => {
          const o = new Set(n);
          return t.reduce(
            (t, n) => [...t, ...Qe(e, (0, T.ensureDefined)(n), o)],
            []
          );
        }),
        Je = (0, xe.createSelector)([Le, Ve, Re], (e, t, n) => {
          const o = new Set(n);
      ...
      function Qe(e, t, n) {
        ...
        for (const r of t.children) {
          const t = e[r];
          void 0 !== t && (o.push(t), n.has(r) && o.push(...Qe(e, t, n)));
        }
        return o;
      }
      function* Xe(e) {
        ...
        yield (0, S.put)(((e) => ({ type: Z, nodes: e }))(o)),
          yield (0, S.put)(Se(t));
        !Ge(yield (0, S.select)()) &&
          t.length > 0 &&
          (yield (0, S.put)(Ie(t[0])), yield (0, S.put)(Ee(t[0])));
      }
      function* et(e) {
        for (;;) {
          if ((yield (0, S.take)([se, le])).type === se) {
            const t = He(yield (0, S.select)()).filter((t) => !e(t));
            yield (0, S.put)(De(t));
      ...
      function* tt() {
        for (;;) {
          ...
          const a = at(t, e === ne ? 'next' : 'previous', n, l),
            { id: c } = a;
          i.includes(c) && r
            ? (yield (0, S.put)(ke(r, !1, 1)), yield (0, S.put)(Ie(c)))
            : yield (0, S.put)(ke(c, !0, 1)),
            yield (0, S.put)(Ee(c));
        }
      }
      function* nt(e, t) {
        for (;;) {
          const { type: n } = yield (0, S.take)([ee, X]),
            o = yield (0, S.select)(),
            r = Ye(o),
            i = Ze(o),
            s = Ge(o);
      ...
      function* st(e) {
        for (;;) {
          yield (0, S.take)(Q);
          const t = Ze(yield (0, S.select)()),
            { node: n, dropType: o } = je(yield (0, S.select)());
          if (n && o) {
      ...
      function at(e, t, n, o) {
        ...
        for (
          ...
          (Math.abs(s) < r &&
            (l = i).level > 1 &&
            !Fe(e, (0, T.ensureDefined)(l.parentId)));
      ...
      var yt = n(42357),
        ...
        St = n(47201),
        wt = n(70412);
      const Ct = o.createContext({ size: 0, smallSizeTreeNodeAction: 1 }),
        Tt = { [C.Modifiers.Mod]: 1, [C.Modifiers.Shift]: 2 };
      var It = n(69533),
        Et = n(75564);
      const kt = () => {};
          ...
          super(...arguments),
            ...
            (this._handleRef = (e) => {
              ...
              (0, T.ensureDefined)(n)(this._ref),
                ...
                (0, T.ensureDefined)(o)((0, _t.getEmptyImage)(), {
      ...
      const Dt = (e) => {
          const {
            ...
            { size: v, smallSizeTreeNodeAction: b } = (0, o.useContext)(Ct),
            y = (0, o.useRef)(null),
            _ = (0, St.createSafeMulticastEventHandler)(
              (e) => (y.current = e),
              h
            );
          let [S, w] = (0, wt.useHover)();
          return (
            (bt.CheckMobile.any() || bt.CheckMobile.isIPad()) &&
              ((S = n), (w = { onMouseOut: kt, onMouseOver: kt })),
            o.createElement(
              'div',
              {
                className: I(
                ...
                onClick:
                  1 === v && 0 === b
                    ...
                    : function (e) {
                        ...
                        const o = Tt[(0, C.modifiersFromEvent)(e)] || 0;
                        !l && s && s(t, !n, o);
                        c && 0 === o && c(e, t);
                      },
                onContextMenu: T,
              ...
              i &&
                o.createElement(k.Icon, {
                  icon: It,
                  className: I(Et.expandHandle, a && Et.expanded),
                  onClick: function (e) {
      ...
      function xt(e, t) {
        ...
        let i = !1,
          s = o.parentId;
        for (; s && !i; ) (i = Be(e, s)), (s = Pe(e, s).parentId);
        return {
          ...o,
          isSelected: r,
          isChildOfSelected: i,
          isExpanded: o.children.length > 0 && Fe(e, n),
      ...
      const zt = (0, F.connect)(xt, Lt, null, { context: Nt })(function (e) {
        ...
        jt = (0, F.connect)(xt, Lt, null, { context: Nt })(Dt);
      var Rt = n(35749),
        At = n(85783),
        Ot = n(65718);
      function Pt(e) {
      ...
      function Vt(e) {
        return o.createElement(Ht, { ...e, ...(0, At.useDragLayer)(Wt) });
      }
      var Gt = n(3085),
        Ut = n(33127);
      ...
      function Kt(e) {
        ...
        return o.createElement(Zt, { ...e, connectDropTarget: n, ref: t });
      }
      const Yt = o.createContext({ isOver: !1, transform: void 0 });
      var $t = n(23490);
      function qt(e) {
      ...
      const Qt = (0, F.connect)(
        function (e) {
          const { boundBox: t, dropType: n, node: o } = je(e);
      ...
      function Xt(e) {
        const { isDragging: t } = (0, At.useDragLayer)(Jt);
        return o.createElement(Qt, { ...e, isDragging: t });
      }
      const en = o.forwardRef((e, t) => {
        const n = (0, o.useContext)(Yt);
        return o.createElement(
          'div',
          { ...e, ref: t },
          e.children,
          n.isOver && o.createElement(Xt, { transform: n.transform })
        );
      });
      var tn = n(38223),
        nn = n(76106);
      const on = 38 + C.Modifiers.Shift,
        rn = 40 + C.Modifiers.Shift;
      const sn = o.forwardRef(function (e, t) {
        ...
        (0, o.useEffect)(() => {
          var e;
          L && (null === (e = j.current) || void 0 === e || e.focus());
        }, []),
          (0, o.useEffect)(() => {
            const e = (e) => {
        ...
        const R = (0, o.useCallback)(() => (0, T.ensureNotNull)(Y.current), []),
          A = (0, o.useCallback)(() => r, [r]),
          O = (0, o.useMemo)(() => {
            const e = h ? jt : zt,
              t = [];
            let n;
        ...
        const B = (0, o.useCallback)((e) => {
            ...
            const { index: n } = e;
            return (
              n === P.current.length - 1 &&
                ((t = { ...t, bottom: 0, minHeight: t.height }),
                delete t.height),
              o.createElement('div', { style: t }, P.current[n].node)
            );
          }, []),
          F = (0, o.useCallback)(
            (e) => {
          ...
          W = (0, o.useCallback)(
            (e) => (0, T.ensure)(P.current[e].node.key),
            []
          ),
          H = (0, o.useMemo)(
            () =>
              null === f
                ? { index: -1 }
                : { index: P.current.findIndex((e) => e.node.key === f.id) },
            [f]
          );
        d(j);
        const [V, G, U, Z] = (0, Ut.useOverlayScroll)(),
          K = (0, o.useRef)(null);
        (0, o.useEffect)(
          ...
          (0, o.useEffect)(
            () => (0, T.ensureNotNull)(K.current).scrollToItem(H.index),
            [H]
          );
        const Y = (0, o.useRef)(null),
          $ = (0, o.useMemo)(() => ({ isOver: D, transform: p }), [D, p]),
          q = (0, o.useRef)(null),
          J = (0, o.useRef)({
            startScroll(e) {
              const t = () => {
        ...
        return (
          (0, o.useImperativeHandle)(t, () => J.current, []),
          (0, o.useEffect)(() => () => J.current.stopScroll(), [D]),
          o.createElement(
            Yt.Provider,
            { value: $ },
            o.createElement(
              'div',
              {
                ...
                onKeyDown: function (e) {
                  ...
                  if (
                    e.defaultPrevented ||
                    (0, Rt.isNativeUIInteraction)(t, e.target)
                  )
                    return;
                  const o = (0, T.ensureDefined)(V.scrollPosTop),
                    r = (0, T.ensureDefined)(V.contentHeight),
                    i = (0, T.ensureDefined)(V.containerHeight);
                  if (i) {
                    const n = 0.875 * i,
                      s = o + i === r;
                    switch (t) {
                      case 35:
                        s || (e.preventDefault(), Q(r));
                        break;
                      case 36:
                        0 !== o && (e.preventDefault(), Q(0));
                        break;
                      case 33:
                        0 !== o && (e.preventDefault(), Q(Math.max(0, o - n)));
                        break;
                      case 34:
                        s || (e.preventDefault(), Q(Math.min(o + n, r)));
                    }
                  }
                  z || t !== on || (e.preventDefault(), b());
                  z || t !== rn || (e.preventDefault(), y());
              ...
              o.createElement(Gt.OverlayScrollContainer, {
                ...V,
      ...
      function cn(e) {
        ...
        return (
          ...
          (0, o.useEffect)(() => {
            null !== f && (null == h ? void 0 : h.id) && f.dispatch(Ie(h.id));
          }, [f, h]),
          null === f
            ? null
            : o.createElement(un, { store: f, scrollToId: p, ...m })
        );
      }
      const un = o.memo(function (e) {
        const { store: t, scrollToId: n, ...r } = e,
          i = 'touch' === e.drag ? H.TouchBackend : W.HTML5Backend;
        return (
          (0, o.useEffect)(() => {
            var e;
            t.dispatch(
      ...
      function gn(e) {
        return (0, B.eventChannel)((t) => {
          const n = {};
          return (
            e.onChange().subscribe(n, () => t({ type: q })),
            e.onGroupCreated().subscribe(n, (e) => t(Me(e, !0))),
            e
              .selection()
              .onChange()
      ...
      function* pn() {
        for (;;) yield (0, S.take)([ee, X]), dn('Select', 'Arrow');
      }
      function* mn() {
        for (;;) {
      ...
      function* fn(e) {
        for (;;) {
          yield (0, S.take)(Q);
          const { node: t, dropType: n } = je(yield (0, S.select)());
          if (t) {
            const o = Ze(yield (0, S.select)()),
      ...
      function* vn(e) {
        yield (0, S.fork)(pn), yield (0, S.fork)(mn), yield (0, S.fork)(fn, e);
      }
      function* bn(e) {
        yield (0, S.fork)(vn, e);
      ...
      const yn = o.createContext(null);
      var _n = n(21861),
        Sn = n(898),
        wn = n(6909);
      const Cn = w.mobiletouch ? 'touch' : 'native';
      function Tn(e) {
        const {
            viewModel: t,
            showHeader: n = !0,
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              {
                className: wn.wrap,
                onContextMenu: _n.preventDefaultForContextMenu,
              },
      ...
      function Nn(e) {
        ...
        return o.createElement(k.Icon, {
          className: E()(Dn.button, n && Dn.disabled, t),
          ...r,
        });
      }
      var xn = n(77975);
      const Ln = v.t(null, void 0, n(91073)),
        zn = v.t(null, void 0, n(35038)),
        jn = v.t(null, void 0, n(15101)),
        Rn = v.t(null, void 0, n(42284)),
        An = v.t(null, void 0, n(31971)),
        On = v.t(null, void 0, n(81428)),
      ...
      function Kn(e) {
        ...
        const V = kn.enabled('test_show_object_tree_debug')
        ...
        return (
          ...
          o.createElement(
                  ...
                  o.createElement(Nn, {
                    ...
                    onClick: z
                      ...
                      : function (e) {
                          if (e.defaultPrevented) return;
                          e.preventDefault(),
                            g.openProperties(u, Bn.TabNames.visibility);
                        },
                    title: (function () {
                      if (!z) return $;
                      return N ? An : On;
            ...
            U &&
              o.createElement(Mn.InputControl, {
                value: _,
                onChange: function (e) {
                  S(e.currentTarget.value);
                },
                onClick: _n.preventDefault,
      ...
      class oo {
        constructor(e) {
          (this._onChange = new Xn.Delegate()),
            (this._recalculate = () => {
              const e = this._groupModel
                  .groups()
                  .map((e) => to(e.id, e.instanceId())),
            ...
            (this._model = e),
            (this._selectionApi = new eo.SelectionApi(this._model)),
        ...
        set(e) {
          ...
          this._selectionApi.set(t.map((e) => no(e).persistentId)),
            (this._selected = n),
            this._onChange.fire(this._selected);
        }
        ...
        buildTree() {
          ...
          for (const t of this._controller.model().panes()) {
            ...
            for (const n of this._groupModel.groups()) {
              const o = to(n.id, n.instanceId()),
                r = (0, T.ensureNotNull)(this._facade.getObjectById(o));
              if (r.pane() === t) {
                const o = [...n.lineTools()]
                  .sort((e, t) => (e.zorder() > t.zorder() ? -1 : 1))
                  .map((e) => to(e.id(), e.instanceId()));
                (e[r.id()] = io(r.id(), 1, t.id(), o)),
                  e[t.id()].children.push(r.id());
                for (const t of o) e[t] = io(t, 2, r.id());
              }
            }
            for (const o of n) {
              const n = to(o.id(), o.instanceId());
              e[n] || ((e[n] = io(n, 1, t.id())), e[t.id()].children.push(n));
            }
      ...
      var so = n(36298),
        ...
        fo = n(28824),
        vo = n(57674);
      const bo = new so.TranslatedString(
          'show {title}',
          v.t(null, void 0, n(87358))
        ),
        yo = new so.TranslatedString(
          'hide {title}',
          v.t(null, void 0, n(70301))
        ),
        _o = new so.TranslatedString(
          'lock {title}',
          v.t(null, void 0, n(50193))
        ),
        So = new so.TranslatedString(
          'unlock {title}',
          v.t(null, void 0, n(92421))
        ),
        wo = new so.TranslatedString(
          'change {sourceTitle} title to {newSourceTitle}',
          v.t(null, void 0, n(40001))
        ),
        Co = new so.TranslatedString(
      ...
      function Io(e) {
        return e instanceof co.DataSource && e.showInObjectTree()
          ? to(e.id(), e.instanceId())
          : null;
      }
      function Eo(e) {
        return new so.TranslatedString(
          e.name(),
          e.title(po.TitleDisplayTarget.DataWindow)
        );
      }
      const ko = new Xn.Delegate();
      class Mo {
        constructor(e, t) {
          (this._syncStateChanged = new Xn.Delegate()),
            ...
            (this._undoModel = e),
            (this._dataSource = t),
            (0, lo.isLineTool)(this._dataSource) &&
          ...
          null !== n &&
            n === t &&
            n.isSynchronizable() &&
            go.isToolCreatingNow.subscribe(this._updateSyncState);
        }
        destroy() {
          (0, lo.isLineTool)(this._dataSource) &&
            (this._dataSource.linkKey().unsubscribe(this._updateSyncState),
            this._dataSource.sharingMode().unsubscribe(this._updateSyncState)),
            go.isToolCreatingNow.unsubscribe(this._updateSyncState);
        }
        id() {
          return to(this._dataSource.id(), this._dataSource.instanceId());
        }
        title() {
          const e = this._dataSource;
          return (0, lo.isLineTool)(e)
            ? e.properties().title.value() || e.translatedType()
            : (0, uo.isSeries)(e) && this._undoModel.mainSeries() === e
              ? e.symbolTitle(
                  po.TitleDisplayTarget.DataWindow,
                  void 0,
                  void 0,
        ...
        gaLabel() {
          return (0, ao.isStudy)(this._dataSource)
            ? 'Study'
            : (0, lo.isLineTool)(this._dataSource)
              ? 'Drawing'
              : 'Symbol';
        ...
        canBeRenamed() {
          return (0, lo.isLineTool)(this._dataSource);
        }
        fullyConstructed() {
        ...
        getIcon() {
          const e = c,
            ...
            n = (0, ao.isStudyStrategy)(this._dataSource);
          let o = { type: En.Svg, content: n ? mo : fo };
          if (e && t)
            if ('loadSvg' === t.type) {
              const [n, r] = t.svgId.split('.'),
                i = 'linetool' === n ? e.linetool[r] : e.series[Number(r)];
              o = { type: En.Svg, content: i || fo };
            } else
              'svgContent' === t.type &&
                (o = { type: En.Svg, content: t.content });
          return o;
        }
        onIconChanged() {
        ...
        setVisible(e) {
          const t = (e ? bo : yo).format({ title: Eo(this._dataSource) });
        ...
        setLocked(e) {
          if ((0, lo.isLineTool)(this._dataSource)) {
        ...
        _insertSources(e, t) {
          ...
          this._undoModel.beginUndoMacro(Co);
          const r = () => {
      ...
      class Do {
        constructor(e, t) {
          (this._onTitleChanged = new Xn.Delegate()),
            (this._onVisibilityChanged = new Xn.Delegate()),
            (this._onLockChanged = new Xn.Delegate()),
            (this._onIsActualIntervalChanged = new Xn.Delegate()),
            (this._syncStateChanged = new Xn.Delegate()),
        ...
        id() {
          return to(this._group.id, this._group.instanceId());
        }
        title() {
        ...
        childrenIds() {
          ...
          return (
            ...
            new Set(e.map((e) => to(e.id(), e.instanceId())))
          );
        }
        hasChildren() {
          return !0;
      ...
      class No {
        constructor(e) {
          (this._hoveredObjectChanged = new Xn.Delegate()),
        ...
        canBeGroupped(e) {
          ...
          if (
            ...
            t.some((e) => !(0, lo.isLineTool)(e) || !e.boundToSymbol()))
          )
            return !1;
          const n = this._undoModel.model(),
        ...
        contextMenuActions(e, t, n) {
          const o = new ho.ActionsProvider(e, n),
            r = [];
          return (
        ...
        _createObjectById(e) {
          const t = no(e).persistentId,
            n = this._undoModel.model(),
            o = n.dataSourceForId(t);
          if (null !== o) return new Mo(this._undoModel, o);
          const r = n.lineToolsGroupModel().groupForId(t);
          return null !== r ? new Do(this._undoModel, r) : null;
        }
      }
      Error;
      var xo = n(80842),
        ...
        Bo = n(33055),
        Fo = n(35149);
      const Wo = (0, l.getLogger)('Platform.GUI.ObjectTree');
      const Ho = new so.TranslatedString(
          'move objects',
          v.t(null, void 0, n(40566))
        ),
        Vo = new so.TranslatedString(
          'lock objects',
          v.t(null, void 0, n(68163))
        ),
        Go = new so.TranslatedString(
          'unlock objects',
          v.t(null, void 0, n(66824))
        ),
        Uo = new so.TranslatedString(
          'show objects',
          v.t(null, void 0, n(63549))
        ),
        Zo = new so.TranslatedString(
          'hide objects',
          v.t(null, void 0, n(28506))
        ),
        Ko = new so.TranslatedString(
          'remove objects',
      ...
      class Yo {
        constructor(e) {
          (this._nodes = {}),
            (this._onChange = new Xn.Delegate()),
            (this._onGroupCreated = new Xn.Delegate()),
            (this._subscriptions = []),
            ...
            (this._isContextMenuOpened = new jo.WatchedValue(!1)),
            ...
            (this._init = () => {
              ...
              e.hasModel() &&
                ...
                (this._groupModel = this._model.lineToolsGroupModel()),
                (this._facade = new No(this._controller)),
                (this._subscriptions = [
                ...
                (this._selection = new oo(this._model)),
                this._update());
            }),
            (this._update = () => {
              null === this._timeout &&
        ...
        isMain(e) {
          return no(e.id()).persistentId === this._controller.mainSeries().id();
        }
        selection() {
        ...
        openProperties(e, t) {
          const n = this._model.dataSourceForId(no(e.id()).persistentId);
            ...
            : (this.selection().set([e]),
              null !== n
                ? this._controller.mainSeries() === n
                  ...
                  : ((0, lo.isLineTool)(n) || (0, ao.isStudy)(n)) &&
        ...
        canSelectionBeUnmerged() {
          ...
          return (
            1 === e.length &&
            this.canNodeWithIdBeUnmerged(no(e[0].id()).persistentId)
          );
        }
        ...
        copySelection() {
          const e = this._getSelectedEntities(),
            t = e.map((e) =>
              (0, T.ensureNotNull)(
                this._model.dataSourceForId(no(e.id()).persistentId)
              )
            );
          this._chart
            .value()
        ...
        async openContextMenu(e, t, n) {
          ...
          if (i.length > 0) {
            ...
            const t = no(e.id()).persistentId,
              r = this._model.dataSourceForId(t),
              s = r instanceof uo.Series,
            ...
            (a = s
              ...
              Lo.ContextMenuManager.showMenu(
                i,
                n,
        ...
        _getActionsForGroupItem(e, t, n) {
          ...
          1 === this._objects.length &&
            r.unshift(this._getRenameAction(t), new zo.Separator()),
            n && r.unshift(this._getGroupAction(), new zo.Separator());
          const i = (0, ho.createSyncDrawingActions)(
            this._chart.value(),
            o.filter(lo.isLineTool)
          );
          i.length && (i.shift(), i.push(new zo.Separator()), r.push(...i));
          const s = this._chart.value().actions().format.getState();
          return (
            r.push(
              new zo.Action({
                actionId: 'ObjectsTree.ToggleItemLocked',
                label: e.isLocked() ? jn : Rn,
                icon: e.isLocked() ? Ro : Ao,
                onExecute: () => this.setIsLocked(e.id(), !e.isLocked()),
              }),
              new zo.Action({
                actionId: 'ObjectsTree.ToggleItemVisibility',
                label: e.isVisible() ? An : On,
                icon: e.isVisible() ? Oo : Po,
        ...
        _unmergeSelection(e) {
          ...
          const n = t[0],
            o = (0, T.ensureNotNull)(
              this._model.dataSourceForId(no(n.id()).persistentId)
            );
          if (!(0, xo.isPriceDataSource)(o))
        ...
        _recalculateTree() {
          const e = new ro(this._controller, this._facade);
      ...
      var $o = n(85067);
      class qo extends $o.DialogRenderer {
        constructor() {
          super(),
            (this._handleClose = () => {
          ...
          const e = (0, Jn.service)(Qn.CHART_WIDGET_COLLECTION_SERVICE);
          (this._activeChartWidget = e.activeChartWidget.value()),
            (this._viewModel = new Yo(e.activeChartWidget));
        }
        hide() {
          this._handleClose();
        }
