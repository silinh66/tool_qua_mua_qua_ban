(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7260],
  {
    ...
    54079: (e, t, s) => {
      ...
      const h = (0, r.forwardRef)(function (e, t) {
        const { onKeyDown: s, orientation: h, ...u } = e,
          m = o.PLATFORM_ACCESSIBILITY_ENABLED
      ...
      function V(e) {
        return class extends r.PureComponent {
          ...
          render() {
            ...
            return r.createElement(
              'div',
              { className: o(t, O.tabs), 'data-name': this.props['data-name'] },
              s,
              r.createElement(e, {
                reference: (e) => {
                  this._slider = e;
    ...
    92574: (e) => {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28"><path fill="currentColor" fillRule="evenodd" d="M11 4h-1v2H7.5A2.5 2.5 0 0 0 5 8.5V13h1v-2h16v8.5c0 .83-.67 1.5-1.5 1.5H14v1h6.5a2.5 2.5 0 0 0 2.5-2.5v-11A2.5 2.5 0 0 0 20.5 6H18V4h-1v2h-6V4Zm6 4V7h-6v1h-1V7H7.5C6.67 7 6 7.67 6 8.5V10h16V8.5c0-.83-.67-1.5-1.5-1.5H18v1h-1Zm-5.15 10.15-3.5-3.5-.7.7L10.29 18H4v1h6.3l-2.65 2.65.7.7 3.5-3.5.36-.35-.36-.35Z"/></svg>';
    },
    79978: (e) => {
      e.exports =
    ...
    69311: (e) => {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" width="18" height="18" fill="none"><path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M9.7 9l4.65-4.65-.7-.7L9 8.29 4.35 3.65l-.7.7L8.29 9l-4.64 4.65.7.7L9 9.71l4.65 4.64.7-.7L9.71 9z"/></svg>';
    },
    90752: (e) => {
      e.exports =
