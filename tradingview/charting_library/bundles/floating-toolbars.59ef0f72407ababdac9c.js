  ...
  [2306],
  {
    ...
    70114: (t, e, o) => {
      ...
      function v(t) {
        const {
          ...
          f = (0, g.useProperty)(e),
          C = (0, i.useRef)(null),
          T = f ? (0, l.parseRgba)(f)[3] : void 0,
          x = '' === f,
          P = String(L()).toLowerCase() === p.white,
          [S, E, W] = (0, d.useCustomColors)();
        return i.createElement(
          u.ToolWidgetMenu,
          {
            className: b,
            verticalDropDirection: w
              ? _.VerticalDropDirection.FromBottomToTop
              : void 0,
            horizontalDropDirection: w
              ? _.HorizontalDropDirection.FromLeftToRight
              : void 0,
            horizontalAttachEdge: w ? _.HorizontalAttachEdge.Left : void 0,
            verticalAttachEdge: w ? _.VerticalAttachEdge.Top : void 0,
            content: i.createElement(
              'div',
              { className: m.wrap },
              i.createElement(a.Icon, { className: m.icon, icon: o }),
              i.createElement(
                'div',
                { className: m.colorBg },
                i.createElement('div', {
                  className: r()(m.color, x && m.multicolor, P && m.white),
                  style: x ? void 0 : { backgroundColor: f },
                })
              )
            ),
            arrow: !1,
    ...
    61259: (t, e, o) => {
      ...
      var i = o(50959),
        ...
        m = o(66611),
        v = o(20835);
      const y = (0, d.mergeThemes)(c.DEFAULT_POPUP_MENU_ITEM_THEME, v),
        w = [
          { value: 1, icon: p },
          { value: 2, icon: u },
          { value: 3, icon: g },
    ...
    27797: (t, e, o) => {
      ...
      var u = o(6914),
        ...
        _ = o(87466);
      function m(t) {
        const { index: e, color: r, selected: a, onSelect: m } = t,
          [v, y] = (0, i.useState)(!1),
          w = (0, i.useContext)(p),
          b = (0, i.useRef)(null),
          f = Boolean(w) && !c.CheckMobile.any();
        return i.createElement(
          i.Fragment,
          null,
          i.createElement('div', {
            ...
            className: n(
              ...
              a && _.selected,
              !r && _.empty,
              String(r).toLowerCase() === u.white && _.white
            ),
            onClick: function () {
              m(r);
            },
      ...
      var S = o(80679);
      const E = '#000000',
        W = s.t(null, { context: 'Color Picker' }, o(40276));
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(
                ...
                i.createElement('span', { className: S.inputHash }, '#'),
      ...
      var B = o(93402);
      const D = s.t(null, { context: 'Color Picker' }, o(53585)),
        k = s.t(null, { context: 'Color Picker' }, o(81865));
            ...
            : i.createElement(
                ...
                i.createElement(
                  ...
                  i.createElement(
                    ...
                    o &&
                      i.createElement('div', {
                        className: r()(B.customButton, 'apply-common-tooltip'),
                ...
                n &&
                  i.createElement(
                    i.Fragment,
                    null,
                    i.createElement('div', { className: B.sectionTitle }, k),
                    i.createElement(y.Opacity, {
                      color: t,
                      opacity: c,
    ...
    3809: (t, e, o) => {
      ...
      const b = 'floating-toolbar-react-widgets',
        f = `<div class="tv-floating-toolbar i-closed i-hidden"><div class="tv-floating-toolbar__widget-wrapper"><div class="tv-floating-toolbar__drag js-drag">${w}</div><div class="tv-floating-toolbar__content js-content"></div><div class="${b}"></div></div></div>`;
      class C {
        constructor(t) {
        ...
        _initSortable() {
          ...
          lazyJqueryUI(this._content).sortable({
            ...
            stop: (e, o) => {
              ...
              t !== i &&
                ((0, y.trackEvent)('Floating Toolbar', 'User Sort'),
    ...
    89824: (t, e, o) => {
      ...
      function E(t) {
        ...
        return i.createElement(P.ToolWidgetIconButton, {
          className: n,
          icon: S,
          title: e,
      ...
      function I(t) {
        ...
        const a = s[0].properties().frozen,
          l = (0, W.useProperty)(a),
          c = l
            ? { title: r.t(null, void 0, o(15101)), icon: k }
            : { title: r.t(null, void 0, o(42284)), icon: N };
        ...
        return (
          ...
          i.createElement(
            V.ToolWidgetMenu,
            {
              ...
              onClick: u,
              title: e,
              content: i.createElement(A.Icon, { icon: q }),
              'data-name': 'more',
      ...
      function ot(t) {
        ...
        return i.createElement(
          V.ToolWidgetMenu,
          {
            className: c,
            arrow: !1,
            content: i.createElement(A.Icon, { icon: it(d) }),
            title: s,
            'data-name': t['data-name'],
            menuDataName: `${t['data-name']}-menu`,
      ...
      const ut = !1,
        ...
        yt = r.t(null, void 0, o(41610)),
        wt = r.t(null, void 0, o(32733)),
      ...
      class ft {
        ...
        _createDotsButton() {
          this._addCommonButton({
            component: Y,
            props: { title: yt, activeChartWidget: this.activeChartWidget() },
            showForSmallScreen: !0,
          });
        }
        _createAlertButton() {}
        ...
        _createProperty(t, e, o, i) {
          if (e) {
            ...
            return this._isWidthProperty(t[0])
              ...
              : new m.CollectibleColorPropertyUndoWrapper(
          ...
          if (t && t.visible())
            return this._isWidthProperty(t)
              ? new h.MultipleLineWidthsProperty([t])
              : new m.CollectibleColorPropertyDirectWrapper(
                  new h.MultipleLineColorsProperty([t])
                );
        }
    ...
    26916: (t, e, o) => {
      ...
      var a = o(94071),
        ...
        _ = o(44352).t(null, void 0, o(12928)),
        m = o(44352).t(null, void 0, o(19221)),
        v = o(44352).t(null, void 0, o(21327)),
        y = o(44352).t(null, void 0, o(38455)),
        w = o(44352).t(null, void 0, o(71845)),
        ...
        P = o(44352).t(null, void 0, o(49593)),
        S = o(44352).t(null, void 0, o(67455)),
    ...
    61964: (t) => {
      t.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" fill="none"><path fill="currentcolor" fillRule="evenodd" clipRule="evenodd" d="M13 5.5c0-.28.22-.5.5-.5h1c.28 0 .5.22.5.5V7.05l.4.09c.9.18 1.73.53 2.46 1.02l.34.23.29-.3.81-.8c.2-.2.52-.2.71 0l.7.7.36-.35-.35.35c.2.2.2.51 0 .7l-.82.82-.29.29.23.34c.49.73.84 1.57 1.02 2.46l.08.4H22.5c.28 0 .5.22.5.5v1a.5.5 0 0 1-.5.5H20.95l-.09.4c-.18.9-.53 1.73-1.02 2.46l-.23.34.3.29.8.81c.2.2.2.52 0 .71l-.7.7a.5.5 0 0 1-.7 0l-.82-.8-.29-.3-.34.23c-.73.49-1.57.84-2.46 1.02l-.4.08V22.5a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5V20.95l-.4-.09a6.96 6.96 0 0 1-2.46-1.02l-.34-.23-.29.3-.81.8.35.36-.35-.35a.5.5 0 0 1-.71 0l-.7-.71a.5.5 0 0 1 0-.7l-.36-.36.35.35.82-.81.29-.29-.23-.34a6.96 6.96 0 0 1-1.02-2.46l-.08-.4H5.5a.5.5 0 0 1-.5-.5v-1c0-.28.22-.5.5-.5H7.05l.09-.4c.18-.9.53-1.73 1.02-2.46l.23-.34-.3-.29-.8-.81a.5.5 0 0 1 0-.71l.7-.7c.2-.2.51-.2.7 0l.82.8.29.3.34-.23a6.96 6.96 0 0 1 2.46-1.02l.4-.08V5.5zm.5-1.5c-.83 0-1.5.67-1.5 1.5v.75c-.73.2-1.43.48-2.06.86l-.54-.53a1.5 1.5 0 0 0-2.12 0l-.7.7a1.5 1.5 0 0 0 0 2.12l.53.54A7.95 7.95 0 0 0 6.25 12H5.5c-.83 0-1.5.67-1.5 1.5v1c0 .83.67 1.5 1.5 1.5h.75c.2.73.48 1.43.86 2.06l-.53.54a1.5 1.5 0 0 0 0 2.12l.7.7a1.5 1.5 0 0 0 2.12 0l.54-.53c.63.38 1.33.67 2.06.86v.75c0 .83.67 1.5 1.5 1.5h1c.83 0 1.5-.67 1.5-1.5v-.75a7.95 7.95 0 0 0 2.06-.86l.54.53a1.5 1.5 0 0 0 2.12 0l.7-.7a1.5 1.5 0 0 0 0-2.12l-.53-.54c.38-.63.67-1.33.86-2.06h.75c.83 0 1.5-.67 1.5-1.5v-1c0-.83-.67-1.5-1.5-1.5h-.75a7.95 7.95 0 0 0-.86-2.06l.53-.54a1.5 1.5 0 0 0 0-2.12l-.7-.7a1.5 1.5 0 0 0-2.12 0l-.54.53A7.95 7.95 0 0 0 16 6.25V5.5c0-.83-.67-1.5-1.5-1.5h-1zM12 14a2 2 0 1 1 4 0 2 2 0 0 1-4 0zm2-3a3 3 0 1 0 0 6 3 3 0 0 0 0-6z"/></svg>';
    },
  },
]);
