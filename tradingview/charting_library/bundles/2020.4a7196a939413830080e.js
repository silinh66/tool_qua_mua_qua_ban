(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2020],
  {
        ...
        return i.createElement(
          N,
          {
            ...
            className: n(
              ...
              T && s,
              {
                'apply-common-tooltip': Boolean(w),
                'common-tooltip-vertical': Boolean(w) && 'vertical' === f,
                [v.isActive]: T,
                [v.isGrayed]: L,
                [v.isHidden]: h,
                [v.isTransparent]: m,
    ...
    10862: (o) => {
      o.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28"><path fill="currentColor" fillRule="evenodd" d="M24.13 14.65a6.2 6.2 0 0 0-.46-9.28c-2.57-2.09-6.39-1.71-8.75.6l-.92.91-.92-.9c-2.36-2.32-6.18-2.7-8.75-.61a6.2 6.2 0 0 0-.46 9.28l9.07 8.92c.58.57 1.53.57 2.12 0l9.07-8.92Zm-9.77 8.2 9.07-8.91a5.2 5.2 0 0 0-.39-7.8c-2.13-1.73-5.38-1.45-7.42.55L14 8.29l-1.62-1.6c-2.03-2-5.29-2.28-7.42-.55a5.2 5.2 0 0 0-.4 7.8l9.08 8.91c.2.2.52.2.72 0Z"/></svg>';
    },
    68385: (o) => {
      o.exports =
